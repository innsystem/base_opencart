...
$_['text_login']               = '<p><b>Comentário permitido apenas para clientes.</b></p> <a href="%s" class="btn btn-sm btn-thema">Acessar Conta</a> ou <a href="%s" class="btn btn-sm btn-primary">Cadastrar-se</a>';
