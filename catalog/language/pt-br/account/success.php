<?php
// Heading
$_['heading_title'] = 'Conta Cadastrada com Sucesso';

// Text
$_['text_message']  = '<p>É com grande satisfação que lhe agradecemos por se cadastrar em nossa loja.</p> <p>Um e-mail de confirmação foi enviado para o e-mail que você utilizou no cadastro de sua conta.</p> <p>Se você tiver qualquer dúvida, entre em <a href="%s">contato</a> conosco.</p>';
