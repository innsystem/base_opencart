...
class ControllerCommonColumnLeft extends Controller
{
	public function index()
	{
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'marketing/newsletters')) {
				$marketing[] = array(
					'name'	   => $this->language->get('text_newsletters'),
					'href'     => $this->url->link('marketing/newsletters', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'marketplace/extension')) {
				$design[] = array(
					'name'	   => $this->language->get('text_extensions'),
