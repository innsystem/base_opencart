...
class ControllerExtensionShippingFree extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_free_city_only'])) {
			$data['shipping_free_city_only'] = $this->request->post['shipping_free_city_only'];
		} else {
			$data['shipping_free_city_only'] = $this->config->get('shipping_free_city_only');
		}
