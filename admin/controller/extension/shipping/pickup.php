...
class ControllerExtensionShippingPickup extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_pickup_horario'])) {
			$data['shipping_pickup_horario'] = $this->request->post['shipping_pickup_horario'];
		} else {
			$data['shipping_pickup_horario'] = $this->config->get('shipping_pickup_horario');
		}

		if (isset($this->request->post['shipping_pickup_endereco'])) {
			$data['shipping_pickup_endereco'] = $this->request->post['shipping_pickup_endereco'];
		} else {
			$data['shipping_pickup_endereco'] = $this->config->get('shipping_pickup_endereco');
		}
