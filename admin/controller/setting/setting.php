...
class ControllerSettingSetting extends Controller
{
	...
	public function index()
	{
		...
		// Adicao de Regras de Compras
		if (isset($this->request->post['config_order_minimum'])) {
			$data['config_order_minimum'] = $this->request->post['config_order_minimum'];
		} else {
			$data['config_order_minimum'] = $this->config->get('config_order_minimum');
		}
