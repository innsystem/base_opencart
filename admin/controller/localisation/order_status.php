...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getForm() {
		...
		$order_info = $this->model_localisation_order_status->getOrderStatus($this->request->get['order_status_id']);

		if (isset($this->request->post['color_type'])) {
			$data['color_type'] = $this->request->post['color_type'];
		} else {
			$data['color_type'] = $order_info['color_type'];
		}
