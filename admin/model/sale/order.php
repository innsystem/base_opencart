...
class ModelSaleOrder extends Model {
	...
	public function getOrderStatusName($nameOrderStatus){

		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_status WHERE name = '". $nameOrderStatus ."' AND language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY name");

		$order_status_name = $query->rows;
